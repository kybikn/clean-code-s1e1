...
var taskInput = document.querySelector(".section__input-add"); //Add a new task.
var addButton = document.querySelector(".section__btn-add"); //first button
var incompleteTaskHolder = document.querySelector(".section__ul-todo"); //ul of #incompleteTasks
var completedTasksHolder = document.querySelector(".section__ul-completed"); //completed-tasks
